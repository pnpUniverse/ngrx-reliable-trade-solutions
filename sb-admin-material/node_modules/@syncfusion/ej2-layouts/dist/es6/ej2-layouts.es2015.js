...
let Splitter = class Splitter extends Component {
    ...
    updateFlexGrow(status) {
        ...
        let visiblePane = collapseCount === this.allPanes.length - 2;
    ...
    getSeparatorIndex(target) {
        ...
        const array = [].slice.call(this.allBars);
    ...
    getPreviousPaneIndex() {
        const prePaneIndex = ((parseInt(this.currentSeparator.style.order, 10) - 1) / 2);
        return prePaneIndex;
    }
    getNextPaneIndex() {
        const nextPaneIndex = (parseInt(this.currentSeparator.style.order, 10) - 1) / (2);
